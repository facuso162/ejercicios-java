...
public class EmpleadosData5b5 {
	
	public static void cargaArregloEmpleados(LinkedList<Empleado> empleados) {
	...
	public static void listarEmpleados(LinkedList<Empleado> empleados) {
